...
hl.bind(main_mod .. "+ L", hl.dsp.exec_cmd("leta-shell"))
hl.bind(main_mod .. "+ SHIFT + L", hl.dsp.exec_cmd("leta-shell quit"))
hl.bind(main_mod .. " + W", hl.dsp.exec_cmd("leta-shell toggle wallpaper-selector"))
hl.bind(main_mod .. " + R", hl.dsp.exec_cmd("leta-shell toggle launcher"))
hl.bind("ALT + SPACE", hl.dsp.exec_cmd("leta-shell toggle launcher"))
